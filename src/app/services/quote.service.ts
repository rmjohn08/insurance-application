/**
 * this service utilizes https://my-json-server.typicode.com api 
 * look at the InlineOrder/quotes repository for the details on the db.json
 * 
 * visit my-json-server for setup instructions
 * 
 */
